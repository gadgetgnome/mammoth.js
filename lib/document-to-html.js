...
function DocumentConversion(options, comments) {
    ...
    function processNestedLists(nodes) {
        return addDataAttributesToLists(nodes);
    }

    function addDataAttributesToLists(nodes) {
        return nodes.map(function(node) {
            if (node.type === "element" && (node.tag.tagName === "ul" || node.tag.tagName === "ol")) {
                // Add sample data attributes to list elements
                var newAttributes = _.extend({}, node.tag.attributes, {
                    "data-num-fmt": node.tag.tagName === "ul" ? "bullet" : "decimal",
                    "data-lvl-text": "",
                    "data-start": "1",
                    "data-lvl-jc": "left",
                    "data-level": "0"
                ...
                return _.extend({}, node, {
                    tag: newTag,
                    children: node.children ? addDataAttributesToLists(node.children) : []
                });
            } else if (node.children) {
                return _.extend({}, node, {
                    children: addDataAttributesToLists(node.children)
                });
            } else {
                return node;
            }
